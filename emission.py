...
def prior_trois_etats(tau=TAU, alpha=ALPHA):
    ...
    Meme calcul, mais les deux intensites ont la meme loi : le resultat ne
    depend que de alpha et tau. Pour alpha = 1 cela vaut [1/2, 1/4, 1/4].
    """
...
def emission(x1, x2, n1, n2, m, tau=TAU, alpha=ALPHA):
    ...
    donnerait log(0) = -inf, que hmmlearn refuse. Le plancher est assez bas
    pour ne rien changer au resultat.
    """
...
if __name__ == "__main__":
    ...
    print(f"chacune de forme (nombre de bins de la region, 3)\n")
